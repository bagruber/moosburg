...
export const jobs: Job[] = [
  ...
  },
  {
    ...
    title: "Erzieher:in städt. KiTa Pfettrach",
    ...
    newPosting: true,
    deadline: "2026-06-30",
    location: "KiTa Pfettrach",
    icon: IconBabyCarriage,
    summary:
      "Drei Stellen für unsere KiTa Pfettrach — Krippe und Kindergartenbereich. Eigene KiTa-Plätze für Mitarbeitende möglich.",
    highlights: [
  ...
  },
  {
    ...
    title: "Hausmeister:in Stadtbücherei",
    bereich: "Bibliothek",
    umfang: ["Teilzeit"],
    ...
    deadline: "2026-05-12",
    closingSoon: true,
    location: "Stadtbücherei Moosburg",
    icon: IconBook2,
    summary:
      "Betreuung des Gebäudes der Stadtbücherei — kleinere Reparaturen, Einrichtung von Veranstaltungsbestuhlung, Pflege Außenanlage.",
  ...
  {
    id: "brk-kita",
    title: "Erzieher:in BRK-KiTa „Sonnenschein“",
    bereich: "Externe Träger",
    umfang: ["Vollzeit"],
    eingruppierung: "S 8a TVöD-SuE",
    unbefristet: true,
    deadline: "2026-06-30",
    location: "BRK-KiTa Sonnenschein, Mühltalstraße",
    icon: IconBabyCarriage,
    external: true,
    summary:
      "Stellenanzeige des Bayerischen Roten Kreuzes — KiTa in städtischer Trägerschaftsbeziehung.",
  ...
  },
  {
    ...
    title: "Pflegefachkraft Pfarrer-Albert-Haus",
    bereich: "Externe Träger",
    umfang: ["Vollzeit", "Teilzeit"],
    eingruppierung: "P 7 AVR Caritas",
    unbefristet: true,
    deadline: "2026-07-15",
    location: "Pfarrer-Albert-Haus",
    icon: IconHeartbeat,
    external: true,
    summary:
      "Vollstationäre Pflegeeinrichtung der Caritas — Pflegefachkräfte für Wohnbereich C gesucht.",
