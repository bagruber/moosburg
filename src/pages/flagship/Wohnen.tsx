...
const SECTIONS = [
  { id: "neu",       label: "Neu in Moosburg",      icon: UserCheck, accent: "rb-6" },
  { id: "geld",      label: "Wohngeld & Hilfen",    icon: Shield,   accent: "rb-5" },
  { id: "mieten",    label: "Wohnen mieten",        icon: Key,      accent: "rb-7" },
  { id: "bauen",     label: "Bauen & Eigentum",     icon: Buildings, accent: "rb-3" },
  { id: "einrichten", label: "Wohnen & Einrichten", icon: Armchair, accent: "rb-4" },
] as const;
      ...
      <article className="mx-auto max-w-7xl px-4 py-12 lg:px-8 lg:py-16">
        <div className="grid gap-12 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
          <div className="space-y-16">
            ...
            {/* ── Neu in Moosburg ──────────────────────────────── */}
            <Sec id="neu" icon={UserCheck} accent="rb-6"
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <BigLink to="/lebenslage/neu-in-moosburg" icon={UserCheck} accent="rb-6"
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <InfoLink to="/lebenslage/pflege-alter" icon={Shield} accent="rb-5"
        ...
        <div className="mt-16 grid gap-12 lg:grid-cols-[minmax(0,2fr)_minmax(0,1fr)]">
          <div className="space-y-6">
            <Sec id="bauen" icon={Buildings} accent="rb-3"
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <BigLink to="/rathaus/bauantrag" icon={Buildings} accent="rb-3"
                title="Bauantrag & Bauberatung"
                body="Drei Wege ins Bauen: Bebauungsplan checken, Antrag stellen oder verfahrensfrei loslegen." />
              <BigLink to="/mitgestalten/stadtentwicklung" icon={MapTrifold} accent="rb-3"
            ...
            {/* ── Wohnen & Einrichten ──────────────────────────── */}
            <Sec id="einrichten" icon={Armchair} accent="rb-4"
    ...
    <Link to={to}
      ...
      <div className="min-w-0 flex-1">
        ...
        <span className="mt-2 inline-flex items-center gap-1 text-sm font-medium text-red-700">
          Öffnen <ArrowRight className="h-3.5 w-3.5" weight="regular" />
        </span>
      </div>
    </Link>
  );
