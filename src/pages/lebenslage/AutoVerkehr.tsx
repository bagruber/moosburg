    ...
    <PageLayout>
      ...
      <SpotlightSection tone="red">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-3">
          <DigitalCard icon={DeviceMobile} title="Handy-Parkticket" body="Parkgebühren bequem per App zahlen, kein Kleingeld nötig." to="/mein-moosburg/mobilitaet" />
          <DigitalCard icon={Car} title="Wunschkennzeichen online" body="Kennzeichen reservieren und Termin gleich mitbuchen." to="/rathaus/online-dienste" />
          <DigitalCard icon={Lightning} title="Ladesäulen finden" body="E-Ladepunkte im Stadtgebiet auf der Karte anzeigen." to="/mein-moosburg/stadtplan" />
        </div>
      </SpotlightSection>
      ...
      <section className="mx-auto max-w-7xl px-4 py-12 lg:px-8 lg:py-16">
        ...
        <div className="mt-10 flex items-start gap-3 rounded-xl border border-ink-line/60 bg-cream-dark px-5 py-4 text-sm text-ink-soft">
          <Info className="mt-0.5 h-5 w-5 shrink-0 text-gold-700" weight="regular" />
          <p>
