...
**Achtung `react-map-gl`.** Steht auf `^8.1.1`, das Lockfile haelt 8.1.1. Version 8.1.2 aendert den Typ von `maxBounds` und bricht `StadtKarte.tsx`, `MoosburgMap.tsx` und `StrassenKarte.tsx`. Beim Update entweder auf 8.1.1 halten oder die drei Aufrufstellen bewusst anpassen.
